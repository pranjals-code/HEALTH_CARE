...
class Permission(BaseModel):
    ...
    )  # patient_record, prescription, lab_result
...
class Organization(BaseModel):
    ...
    patients = relationship(
        "Patient", back_populates="organization", cascade="all, delete-orphan"
    )
    staff_profiles = relationship(
        "StaffProfile", back_populates="organization", cascade="all, delete-orphan"
    )
