...
class OTPTestClient:
    ...
    def register_with_phone(self, email: str, phone: str, first_name: str, last_name: str) -> Optional[dict]:
        ...
        try:
            ...
            resp = self.session.post(
                f"{self.base_url}/auth/register-phone",
                json=payload
            )
    ...
    def verify_otp(self, phone: str, otp: str, password: str) -> Optional[dict]:
        ...
        try:
            ...
            resp = self.session.post(
                f"{self.base_url}/auth/verify-phone-otp",
                json=payload
            )
